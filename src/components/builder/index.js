        ...
        return (
            <div class="container outfit-generator">
                <div class="aside">
                    ...
                    <p>Wouldn’t it be great if you had a M&S outfit generator that you could use to get some
                        inspiration!</p>
                    <Link to="/" class="button button--arrow button-outfit-builder">Outfit generator <svg width="20px"
                                                                                                          height="15px"
                                                                                                          viewBox="0 0 40 40"
                                                                                                          version="1.1"
