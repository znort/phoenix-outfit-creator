        ...
        return (
            <div className="container outfit-generator">
                <div className="aside">
                    ...
                    <Link to="/generate-builder" class="button button--arrow button-outfit-builder">Outfit builder <svg width="20px" height="15px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
