                ...
                <div class="outfit-layout outfit-layout--five">
                    <div class="outfit-tile-group">
                        <div class="outfit-tile">
                            <img src=""/>
                            <p>£30</p>
                            <button class="button button--icon button--refresh"><span class="acc-text">Refresh</span>
                            </button>
                        </div>
                        <div class="outfit-tile">
                            <img src=""/>
                    ...
                    <div class="footer">
                        <ul class="tile-chooser">
                            ...
                            <li class="tile tile--three">
                                <button class="button button--icon"><span class="acc-text">Show three items</span>
                                </button>
                            </li>
                            <li class="tile tile--four">
                                <button class="button button--icon"><span class="acc-text">Show four items</span>
                                </button>
                            </li>
                            <li class="tile tile--five">
                                <button class="button button--icon"><span class="acc-text">Show five items</span>
                                </button>
                            </li>
                        </ul>
                            ...
                            <button class="button button--inverted button--icon">
                                <svg width="30px" height="30px" viewBox="0 0 30 30" version="1.1"
                                    ...
                                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g id="Default---Inspire-Me-(5-products)"
                                           transform="translate(-663.000000, -518.000000)">
